...
function replace any properties that you wish to have evaluated in a 
lazy manner with functions whose environments are not reset.
For example, in the two equivalent alternatives below \code{g}
